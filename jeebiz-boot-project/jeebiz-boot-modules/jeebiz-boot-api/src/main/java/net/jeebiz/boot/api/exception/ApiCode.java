...
　　	 *								        注意：某些代理服务器在DNS查询超时时会返回400或者500错误
	 ...
	 * RuntimeException					      
	 */
	SC_RUNTIME_EXCEPTION("10104", "[服务器]运行时异常"),
	/**
	 * NullPointerException				      
	 */
	SC_NULL_POINTER_EXCEPTION("10105", "[服务器]空值异常"),
	/**
	 * ClassCastException				      
	 */
	SC_CLASS_CAST_EXCEPTION("10106", "[服务器]数据类型转换异常"),
	/**
	 * IOException						      
	 */
	SC_IO_EXCEPTION ("10107", "[服务器]IO异常"),
	/**
	 * NoSuchMethodException			      
	 */
	SC_NO_SUCH_METHOD_EXCEPTION("10108", "[服务器]未知方法异常"),
	/**
	 * IndexOutOfBoundsException		      
	 */
	SC_INDEX_OUT_OF_BOUNDS_EXCEPTION("10109", "[服务器]数组越界异常"),
	/**
	 * NetworkException					      
	 */
	SC_NETWORK_EXCEPTION("101010", "[服务器]网络异常"),
	
	/**
	 * MethodArgumentNotValidException
	 * BindException					      
	 */
	SC_VALID_EXCEPTION("10111", "参数验证失败");
  
	private final String code;
	private final String reason;
	
    private ApiCode(String code, String reason) {
        this.code = code;
        this.reason = reason;
    }
