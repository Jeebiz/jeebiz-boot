...
public enum ByteUnitFormat {
    ...
    public final String to(ByteUnitFormat targetFormat, long value, int scale) {
        return to(targetFormat, value, Rate.IEC, scale, RoundingMode.HALF_UP, true);
    }
    ...
    public final String to(ByteUnitFormat targetFormat, long value, Rate rate, int scale) {
        return to(targetFormat, value, rate, scale, RoundingMode.HALF_UP, true);
    }

    public final String to(ByteUnitFormat targetFormat, long value, Rate rate, boolean displayUnitName) {
        return to(targetFormat, value, rate, 2, RoundingMode.HALF_UP, displayUnitName);
    }
    
    public final String to(ByteUnitFormat targetFormat, long value, Rate rate, int scale, boolean displayUnitName) {
        return to(targetFormat, value, rate, scale, RoundingMode.HALF_UP, displayUnitName);
    }
    
    public final String to(ByteUnitFormat targetFormat, long value, boolean displayUnitName) {
        return to(targetFormat, value, Rate.IEC, 2, RoundingMode.HALF_UP, displayUnitName);
    }
    
    public final long toLong(ByteUnitFormat targetFormat, long value) {
    	return Long.parseLong(this.to(targetFormat, value, Rate.IEC, 0, false));
    }
    
    public final long toLong(ByteUnitFormat targetFormat, long value, Rate rate) {
    	return Long.parseLong(this.to(targetFormat, value, rate, 0, false));
    }
    
    public final double toDouble(ByteUnitFormat targetFormat, long value) {
    	return Double.parseDouble(this.to(targetFormat, value, Rate.IEC, 2, false));
    }
    
    public final double toDouble(ByteUnitFormat targetFormat, long value, Rate rate) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ByteUnitFormat.B.to(ByteUnitFormat.K, 1024L, Rate.IEC, false));
        System.out.println(ByteUnitFormat.B.to(ByteUnitFormat.K, 1024L, false));
